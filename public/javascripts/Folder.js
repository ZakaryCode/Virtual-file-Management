...
GLOBAL.Folder.checkFolderAll = function(data){
	...
	GLOBAL.Compiler.AJAX( "Folder", "checkFolderAll", OpObject, LoginSuc );
};
//显示->指定目录详情
GLOBAL.Folder.checkFolderDetail = function(data){
	...
	GLOBAL.Compiler.AJAX( "Folder", "checkFolderDetail", OpObject, LoginSuc );
};
//新建->A目录/文件->指定目录
...
GLOBAL.Compiler.AJAX( "Folder", "newFolder", OpObject, LoginSuc );
};
//删除->指定目录下->A目录/文件
...
GLOBAL.Compiler.AJAX( "Folder", "deleteFolder", OpObject, LoginSuc );
};
...
GLOBAL.Compiler.AJAX( "Folder", "alterFolder", OpObject, LoginSuc );
};
